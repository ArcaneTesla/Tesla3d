...
namespace tsl {
    ...
    void TslPipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo) {
        ...
        configInfo.bindingDescriptions = TslModel::Vertex::getBindingDescriptions();
        configInfo.attributeDescriptions = TslModel::Vertex::getAttributeDescriptions();
    }

    void TslPipeline::enableAlphaBlending(PipelineConfigInfo& configInfo) {
